...
public class IdentifyCornerOfInputScreen_showMultipleObjectsOnScreen_2obj_6Flags extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    boolean flag6 = false;  //flag6 - object 2 & 3      //aimply just have more configurations/combinations, but rect obj positions still the same!
...
//    boolean TimerFlag3;   //flag set for CountDownTimer 3
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Timer1 = new CountDownTimer(12000, 2000) {
...
//                if (secsLeft == 23){    //flag1==true   //object 1 & 4
                    if (clear2 == true){
                        Lives -=1;
                    }
                    if (clear3 == true){
...
//                    flag1=false;    //Specifying rect coords directly here won't work, cos OnCameraFrame() method not even ready yet, so InputFrame won't be avail at this moment in time!
//                    flag2=false;
//                    flag3=false;
//                    flag4=false;
...
//
//                    //BUT NOW I FACE A NEW PROB, HOW WILL PROG KNOW WHAT FLAG IT SET EARLIER? What if is the same one? Fuck it?
//                    //nd a flag checker - no this Logic
...
//                    }
                    ...
                    //Print out output to see which set gets flag by this Random Generator
                    ...
                    Log.d("bool ","flag5 "+ flag5);
                    Log.d("bool ","flag6 "+ flag6);
                }


                if (secsLeft == 9){    //flag2==true   //object 2 & 4
//                if (secsLeft == 19){    //flag2==true   //object 2 & 4
                    if (clear1 == true){
                        Lives -=1;
                    }
                    if (clear4 == true){
...
//                if (secsLeft == 15){    //flag3==true   //object 3 & 1
                    if (clear2 == true){
                        Lives -=1;
                    }
                    if (clear4 == true){
...
//                        onStop();
                    ...
                    Log.d("flag 2","heehee");   //:o finally showing :)
                ...
                if (secsLeft == 5){    //flag4==true   //object 3 & 4
//                if (secsLeft == 11){    //flag4==true   //object 3 & 4
                    if (clear1 == true){
                        Lives -=1;
                    }
                    if (clear3 == true){
...
//                        onStop();
                ...
                if (secsLeft == 3){    //flag5==true   //object 1 & 2
//                if (secsLeft == 7){    //flag5==true   //object 1 & 2
                    if (clear3 == true){
                        Lives -=1;
                    }
                    if (clear4 == true){
...
//                        onStop();
                    ...
                    flag1=false; clear1=true;
                    flag2=false; clear2=true;
                    flag3=false; clear3=false;
                    flag4=false; clear4=false;    //flag5   //object 1 & 2
                    flag5=true;
                    flag6=false;
                ...
                if (secsLeft == 1){    //flag6==true   //object 2 & 3
//                if (secsLeft == 3){    //flag6==true   //object 2 & 3
                    if (clear1 == true){
                        Lives -=1;
                    }
                    if (clear2 == true){
...
//                        onStop();
                    ...
                    flag2=false; clear2=true;
                    flag3=false; clear3=true;
                    flag4=false; clear4=false;    //flag6   //object 2 & 3
                    flag5=false;
                    flag6=true;
