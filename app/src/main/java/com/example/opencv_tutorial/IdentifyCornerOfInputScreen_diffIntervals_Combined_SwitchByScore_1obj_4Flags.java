...
public class IdentifyCornerOfInputScreen_diffIntervals_Combined_SwitchByScore_1obj_4Flags extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
...
//        final CountDownTimer Timer4 = new CountDownTimer(8000, 2000) {
        Timer4 = new CountDownTimer(8000, 2000) {
...
//        final CountDownTimer Timer3 = new CountDownTimer(20000, 5000) {
        Timer3 = new CountDownTimer(20000, 5000) {
...
//        final CountDownTimer Timer2 = new CountDownTimer(8000, 2000) {
        Timer2 = new CountDownTimer(8000, 2000) {
