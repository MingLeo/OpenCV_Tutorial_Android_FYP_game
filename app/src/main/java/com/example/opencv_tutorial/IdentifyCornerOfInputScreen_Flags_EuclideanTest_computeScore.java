...
public class IdentifyCornerOfInputScreen_Flags_EuclideanTest_computeScore extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hsv_colour);   //setting the layout view in accordance to the specifications of one of the layout resource file under res/la
        ...
        if (checkSelfPermission(Manifest.permission.CAMERA)
            ...
            scoreText = (TextView) findViewById(R.id.textView3);    //update the score to this textbox
...
//            mc.add(new Point(mu.get(0).m10 / (mu.get(0).m00 + 1e-5), mu.get(0).m01 / (mu.get(0).m00 + 1e-5)));   //index 0 cos there shld only be 1 contouest one only!
    ...
    //Euclidean Dist Algorithm for Centroid Matching!
        if (flag1 == true) {
            ...
            if (distance < 65) {   //threshold value for a positive match!
                ...
                //                Log.d("Ahh..", "topLeft & Object matched");
                computeScore();
                flag1=false;
                //do domething, remove the object displayed, set a flag to disable object from being shown.
            }
        }
